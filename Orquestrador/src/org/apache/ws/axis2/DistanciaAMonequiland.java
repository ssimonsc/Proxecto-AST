...
/**
 *  DistanciaAMonequiland bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DistanciaAMonequiland implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://ws.apache.org/axis2",
            "DistanciaAMonequiland", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DistanciaAMonequiland", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DistanciaAMonequiland", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DistanciaAMonequiland parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DistanciaAMonequiland object = new DistanciaAMonequiland();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DistanciaAMonequiland".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DistanciaAMonequiland) org.apache.ws.axis2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
