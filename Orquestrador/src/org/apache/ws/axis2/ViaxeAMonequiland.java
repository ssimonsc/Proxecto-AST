...
/**
 *  ViaxeAMonequiland bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ViaxeAMonequiland implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://ws.apache.org/axis2",
            "ViaxeAMonequiland", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ViaxeAMonequiland", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ViaxeAMonequiland", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ViaxeAMonequiland parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ViaxeAMonequiland object = new ViaxeAMonequiland();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ViaxeAMonequiland".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ViaxeAMonequiland) org.apache.ws.axis2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
