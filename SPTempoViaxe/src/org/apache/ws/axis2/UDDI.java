...
public class UDDI {
	...
	public String publish(String servicio, String endpoint) {
		...
		{    	
                ...
                if (register == null) {
                        System.out.println("Fallou o rexistro do negocio!");
                        return null;
                }                
	 ...
	 public static void main(String args[]) {
         ...
         UDDI sp = new UDDI();
         String serv = "Cache";
         String endpoint = "http://localhost:8080/axis2/services/Cache";
  ...
  // sp.unPublish("uddi:juddi.apache.org:30892a91-af93-4f6e-851c-64dbe987c80b","uddi:juddi.apache.org:6686c5af-9a2c-47aa-b1eb-7efea8479877",serv,"AST");
 }
