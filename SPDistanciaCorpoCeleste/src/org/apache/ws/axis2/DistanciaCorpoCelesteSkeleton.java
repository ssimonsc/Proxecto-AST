 ...
 */
public class DistanciaCorpoCelesteSkeleton implements ServiceLifeCycle{
	...
	public void shutDown(ConfigurationContext arg0, AxisService arg1) {
		...
		uddi.unPublish(serv_key,bus_key,"DistanciaCorpoCeleste","AST");
	}
	...
	public void startUp(ConfigurationContext arg0, AxisService arg1) {
		...
		bus_serv=uddi.publish("DistanciaCorpoCeleste","http://localhost:8080/axis2/services/DistanciaCorpoCeleste");
